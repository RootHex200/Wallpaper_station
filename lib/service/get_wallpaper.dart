...
class Get_all_wallpaper {
  Future getWallpaperdata() async {
    var response = await Dio().get(
        ...
        options: Options(headers: {
          ...
          'X-RapidAPI-Key': '72b8cbfa1cmshb0dee9053314f80p1f7ac2jsnf6994128d8f5'
        }));
  ...
  Future getCategroys() async {
    var response = await Dio().get(
        "https://best-manga-anime-wallpapers.p.rapidapi.com/categories",
        options: Options(headers: {
          'X-RapidAPI-Host': 'best-manga-anime-wallpapers.p.rapidapi.com',
          'X-RapidAPI-Key': '72b8cbfa1cmshb0dee9053314f80p1f7ac2jsnf6994128d8f5'
        }));
    ...
    if (response.statusCode == 200) {
      if (response.data != null) {
        return response.data.map((item)=>Categories.fromJson(item)).toList();
      } else {
        return [];
      }
    }
